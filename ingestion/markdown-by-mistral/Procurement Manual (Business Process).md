...
| Role | Responsibilities |
| :--: | :--: |
| SRM Specialist | 1. Share 'Risk Identification, Assessment, and Mitigation Form' with Sourcing Leads and Contract Administrators <br> 2. Consolidate responses and create 'Risk Register and Mitigation Tracker'. <br> 3. Identify high priority procurement risks. <br> 4. Share approved 'Risk Register and Mitigation Tracker' with relevant stakeholders for mitigation of high priority risks. <br> 5. Monitor mitigation of high priority risks. <br> 6. Communicate closure of 'Risk Register and Mitigation Tracker' to relevant stakeholders. |
...
| Role | Responsibilities |
| :--: | :-- |
| Risk and Regulation Lead | 1. Assess upcoming regulation change to identify impacts on the Procurement. <br> 2. Complete and share the 'Regulation Change Plan'. <br> 3. Share the approved 'Regulation Change Plan' with relevant stakeholders. <br> 4. Conduct periodic reviews of the 'Regulation Change Plan'. <br> 5. Communicate completion of 'Regulation Change Plan' to relevant stakeholders. |
...
| Procurement Processes |  | Work Aids |  |
| :-- | :-- | :-- | :-- |
| 2.7.2. (I) | Profile Supplier Risk | Supplier Risk Profiling Input Collection Form |  |
|  |  | Supplier Risk Profiling Report |  |
| 2.7.2. (II) | Manage Procurement Risks | Risk Identification, Assessment, and Mitigation Form |  |
...
| L3 Process |  |  |  |  |  |  |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  |  | SRM Specialist | Regulation and Risk Lead - GPO | Contract <br> Administrator / <br> End Users | Category <br> Managers | Supplier | Sourcing Lead | Finance / Legal | Approves <br> (as per PDDA) | Procurement Scope |
|  |  |  |  |  |  |  |  |  |  |
| 2.7.2. (I) Profile Supplier Risk |  | R, A |  | R | R | I |  |  |  | GPO / <br> Entity |
| 2.7.2. (II) Manage Procurement Risks |  | R, A |  | R | R | R | R |  | R | GPO / <br> Entity |
...
| Role | Responsibilities |
| :--: | :--: |
| Supplier | 1. Raise "Self Registration Request", in case of AD-DED Suppliers. <br> 2. Request an Entity to raise "Entity Raised Supplier Request", in case of Non - ADDED Suppliers. <br> 3. Provide all information and documentation requested by the Entity to raise the "Entity Raised Supplier Request". |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier Data <br> Management Lead | 5. Assign "Registration Request" to one of the Supplier Data Management <br> Specialists. |
| Supplier Data <br> Management Specialist | 6. Review the "Registration Request" for accuracy and duplication. <br> 7. Assign "Supplier Manager". |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier | 1. Update information in the "General Registration Questionnaire" and "Payment and <br> Bank Questionnaire" |
| Entity User | 2. Prepare and Publish quick survey to activate a "Registered" Non - AD-DED Supplier to <br> the Entity's scope. |
| Supplier Manager | 3. Review and approve the "General Registration Questionnaire", (if updated) <br> 4. Update the "Internal Questionnaire" (if reqd.) |
| Bank Information <br> Specialist | 5. Review and approve the "Payment and Bank Questionnaire" (if updated) |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier | 1. Receive the "Qualification Questionnaire". <br> 2. Complete and submit "Qualification Questionnaire". |
| Entity User | 3. Request "Supplier Manager" to disqualify a Supplier. |
| Supplier Manager | 4. Send "Qualification Questionnaire" to the Supplier. <br> 5. Review and approve the "Qualification Questionnaire". <br> 6. Disqualify Supplier. |
| Supplier Data <br> Management Lead | 7. Review and approve the "Qualification Questionnaire". |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier <br> Manager | 1. Decide if the Supplier should be marked as "Preferred" for a category or not. <br> 2. Mark the Supplier "Preferred", if required. |
...
| Supplier Data <br> Management Specialist | 2. Mark the Supplier "Deactivated" and provide justification. |
| Supplier | 3. Update the commercial/industrial License in "General Registration <br> Questionnaire" |
| Supplier Manager | 4. Review and approve request to open the "General Registration Questionnaire". <br> 5. Review the renewed commercial/industrial license. <br> 6. Mark the supplier "Reactivated" and provide justification. |
...
| L3 Process | Supplier <br> Management <br> Data Lead | Supplier <br> Management <br> Data Specialist | Entity User | Supplier | Supplier <br> Manager | Bank <br> Information <br> Specialist | Procurement <br> Scope |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
7. Add/modify/delete Item record
...
9. Procedures and Methodologies
...
| L3 Process | Entity <br> Requestor | Master Data <br> Team | Designated <br> Approvers | Procurement <br> Scope |
| :--: | :--: | :--: | :--: | :--: |
...
ii. This request is approved by designated approvers ${ }_{\text {. }}$
...
| --- | --- |
|  2.4.2.(IV)_1 | Relax request to terminate contract  |
|  Contract Termination required |   |
|  2.4.2.(IV)_2 | Create/update "Termination Notice" and provide supporting documents  |
|  2.4.2.(IV)_3 | Review "Contract Closure Checklist" and complete relevant activities  |
|  2.4.2.(IV)_4 | Approve "Contract Closure Checklist" and provide relevant documents  |
|  2.4.2.(IV)_5 | Review "Termination Notice" along with supporting documents  |
|  2.4.2.(IV)_6 | Approve/deny "Termination Notice" along with supporting documents  |
|  2.4.2.(IV)_7 | Complete "Contract Closure Checklist" and provide relevant documents  |
|  2.4.2.(IV)_8 | Send "Termination Notice" to Supplier  |

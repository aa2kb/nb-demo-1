...
| Strategic | Procurement Strategy |  | Demand and Category Management |  |
| :--: | :--: | :--: | :--: | :--: |
...
In case, an additional Souring Event within the original "Full Sourcing Project" is used for recording negotiated bids in "SAP Ariba", the "Project Owner" completes all activities specified in Prepare and Publish Sourcing Event for a "Full Sourcing Project".
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Create the post-negotiations Sourcing Event. <br> 2. Prepare and publish the Sourcing Event. <br> 3. Review and verify the Suppliers' responses. |
| Approvers <br> (as per PDoA) | 4. Review and approve/deny the Sourcing Event before it is published. |
| Suppliers | 5. Update and submit the Sourcing Event response. |
...
| :-- | :-- | :-- | :-- | :-- |
|  |  |  |  |  |
| - Project Owner <br> - Suppliers <br> - Approvers (as per <br> PDoA) | Which Suppliers <br> should be invited to <br> submit final <br> responses? | - Original Sourcing <br> Event Content and <br> Supplier responses | - Negotiated <br> responses recorded <br> in "SAP Ariba" | - 'Main Contract <br> Document' <br> - Sourcing Event <br> Content |
...
| Section Name | Description |
| :-- | :-- |
| 1. Executive Summary | To provide an executive summary of the 'Award Recommendation Report' document. |
| 2. Recommendation <br> Summary | To document details of bidder(s) recommended for award. |
| 3. Savings Summary | To document the projected savings. |
| 4. Sourcing Event <br> Chronology | To document the chronology for the "Sourcing Project". |
| 5. Evaluation Criteria | To summarize the technical and commercial evaluation criteria. |
| 6. Technical Evaluation <br> Summary | To compare and summarize the technical qualifications for shortlisted bidders. |
| 7. Commercial Evaluation | To summarize the overall cost comparison for shortlisted bidders. |
| 8. Negotiation | To summarize the negotiation outcomes. |
| 9. Contract Details | To summarize the contract details including final delivery schedule \& timetable. |
...
Once the "Award Scenarios" are "Approved", "SAP Ariba" can automatically send a systemgenerated email to the winning Suppliers, providing them with the details of the line items awarded to them. The "Project Owner" needs to enable this automated email when creating the "Award Scenarios".
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Create/update and submit 'Award Recommendation Report' and "Award Scenario". <br> 2. Communicate award to winning Suppliers and confirm acceptance/rejection. <br> 3. If winning Suppliers reject the award, decide on the next course of action and coordinate with the Finance to appropriate the Bid Bond amount (if applicable). <br> 4. If winning Suppliers reject the award, prepare and publish additional "Quick Sourcing Project" within the same SR to obtain final bids from next eligible Suppliers. |

--- Page 79 ---

| Role | Responsibilities |
| :--: | :-- |
| Approvers <br> (as per PDoA) | 5. Review and approve/deny the 'Award Recommendation Report' and "Award Scenario". |
| Suppliers | 6. Review and approve/deny the award. |
...
The "Project Owner" creates an 'Event Cancellation Request' and submit it for approval by the "Approvers" designated as per the PDoA.
...
| Role | Responsibilities |
| :--: | :-- |
| Project <br> Owner | 1. Add "Cancel Sourcing Event" task in the "Sourcing Project". <br> 2. Prepare and submit the 'Event Cancellation Request'. <br> 3. Cancel the Sourcing Event and notify Suppliers via 'Event Cancellation Notice'. <br> 4. Cancel "Sourcing Project"/"Sourcing Request", if required. |
| Approvers | 5. Review and approve/deny the 'Sourcing Event Cancellation Request'. <br> 6. Review and approve/deny the "Sourcing Project"/"Sourcing Request" cancellation. |
...
|  |  |  |
| :-- | :-- | :-- |
| 2.3.3. (I) | Prepare and Approve "Sourcing Request" | Overview Form |
| 2.3.3. (II) | Create "Sourcing Project" | Overview Form |
|  |  | Tendering Committee Creation Form |
| 2.3.3. (III) | Develop and Approve 'Sourcing Strategy' | Sourcing Strategy |
| 2.3.3. (IV) | Prepare and Publish Sourcing Event | Sourcing Event Content |

--- Page 82 ---

|  |  | Draft 'Main Contract Document' |
| :--: | :--: | :--: |
| 2.3.3. (V) | Execute and Monitor Sourcing Event | Sourcing Event Content |
|  |  | Draft 'Main Contract Document' |
| 2.3.3. (VI) | Evaluate Sourcing Event | Technical Evaluation Form |
|  |  | Commercial Evaluation Form |
| 2.3.3. (VII) | Conduct Negotiations | Negotiations Plan |
|  |  | Negotiations Bidders List Request |
| 2.3.3.(VIII) | Conduct Post Negotiations Sourcing Event | Sourcing Event Content |
| 2.3.3. (IX) | Award \& Event Closeout | Award Recommendation Report |
| 2.3.3. (X) | Cancel Sourcing Event | Event Cancellation Request / Event Modification Request |
...
| L3 Process | Requestor <br> (End-User DepL) | Sourcing <br> Specialist/Lead | Supplier | Approvers <br> (as per P20A) | Tendering <br> Committee | Contract <br> Manager | Procurement <br> Scope |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 2.3.3. (I) Prepare \& Approve Sourcing Request (SR) | I | $R, A$ |  | R |  |  | GPO / Entity |
| 2.3.3. (II) Create Sourcing Project | C | $R, A$ |  |  |  |  | GPO / Entity |
| 2.3.3. (III) Develop \& Approve Sourcing Strategy | I | $R, A$ |  | R | R |  | GPO / Entity |
| 2.3.3. (IV) Prepare \& Publish Sourcing Event | I | $R, A$ | I | R |  | R | GPO / Entity |
| 2.3.3. (V) Execute \& Monitor Sourcing Event | C | $R, A$ | R |  |  |  | GPO / Entity |
| 2.3.3. (VI) Evaluate Sourcing Event |  | $R, A$ |  |  | R |  | GPO / Entity |
| 2.3.3. (VII) Conduct Negotiations | C | $R, A$ | R |  | C |  | GPO / Entity |
| 2.3.3. (VIII) Create \& Execute Post Negotiations Quick Project | C | $R, A$ | R |  |  |  | GPO / Entity |
...
The CLM process group is enabled through the "SAP Ariba Contract Lifecycle Management (CLM) module". Each contract associates to a "Contract Workspace" (in the "CLM module") which has predefined "Tasks", "Team Members", "Documents", and approval chains configured to enable efficient creation and management of any contract.
...
Depending upon the number of winning Suppliers, multiple "Contract Workspaces" may be created against a "Sourcing Project". In this case, each "Contract Workspace" has the 'Main Contract Document' and "Contract Line Item Details (CLID)" specific to the Supplier. Below is an illustration of the same:
...
Contains elements specific to each Entity e.g., delivery locations (Corniche 2), authorized requesters, SLAs

Contains delivery request(s) issues by each Entity defining date(s), quantity etc. in line with the provisions on FA and call off contract. e.g., PO for entity 2 for 3 apples at 3AED each to be delivered at Corniche
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner <br> (Sourcing Project) | 1. Create "Contract Workspace". <br> 2. Set the assigned Contracting Specialist/Lead as "Project Owner". |
| Project Owner <br> (Contract <br> Workspace) | 3. Create "Contract Workspace". <br> 4. Assign "Team Members". <br> 5. Prepare/update the 'Main Contract Document' and "CLID" in the "Contract Folder". <br> 6. Initiate "Review" task(s). <br> 7. "Accept All Changes" recommended by the "Reviewers" or initiate another round of <br> review. |
| Reviewers <br> (as per PDoA) | 8. Review documents in the "Contract Folder". <br> 9. In case of modifications, provide modified documents. |
...
Please refer to Appendix 3.1 - 2.4.3.(I) Initiate and Review Contract for the process map.
...
f. Step 6 - In case the review by the "Reviewers" is not required, the "Project Owner" retriggers the "Approval" task.
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Initiate "Approval" task. <br> 2. Modify the documents in the "Contract Folder" as per "Approvers" recommendations. <br> 3. Obtain contract signatures on the 'Main Contract Document' from the respective <br> stakeholders. <br> 4. Create "Supplier Performance Management (SPM) Project". <br> 5. Publish the contract through the "Overview" tab. <br> 6. Share a signed copy of the 'Main Contract Document' with the Supplier. |
| Approvers <br> (as per PDoA) | 7. Review and approve/deny the documents in the "Contract Folder". |
...
| Role | Responsibilities |
| :--: | :--: |
| Contract <br> Administrator | 1. Raise/ receive an amendment from the Supplier. <br> 2. Review the amendment along with the Budget Owner. <br> 3. If amendment is valid, communicate details to the "Project Owner". <br> 4. If amendment is invalid, inform the stakeholder and resolve any query. |
| Project Owner | 5. Receive details of amendment from the Contract Administrator. <br> 6. Select the amendment type and Initiate amendment tasks in the "Contract Workspace." <br> 7. In case of 'Administrative' amendment - modify "Overview" details and/or the "Team Members" and publish. <br> 8. In case of 'Amendment',' Extension / Renewal' - amend the required documents in the "Contract Folder". <br> 9. In case of 'Termination', review the "Termination Checklist" and add 'Termination Notice' in the "Contract Folder". <br> 10. Add any additional documents in the "Contract Folder", if required. |
...
Please refer to Appendix 3.1- 2.4.3.(III) Initiate Contract Amendment for the process map.

# 2.4.3.(IV) Review and Finalize Contract Amendment 

## i. (B) Scope and Purpose

This process is applicable only for 'Amendment', 'Renewal/Extension', and 'Termination' amendments. The review and approval process for these amendments are same as that for the original contract explained in section 2.4.3.(I)ii.7J and section 2.4.3.(II).
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Initiate "Review" task(s). <br> 2. Initiate "Approval" task. <br> 3. Modify documents in the "Contract Folder" as per "Approvers" recommendations. <br> 4. Obtain contract signatures from relevant stakeholders. <br> 5. Publish amended contract through the "Overview" tab. <br> 6. Share a signed copy of the amended contract with the Supplier. <br> 7. "Accept All Changes" recommended by the "Reviewers" or initiate another round of <br> review. |
| Reviewers <br> (as per PDoA) | 8. Review the documents in the "Contract Folder". <br> 9. In case the review leads to modifications, provide the modified documents. |
| Approvers <br> (as per PDoA) | 10. Review and approve/deny the documents in the "Contract Folder". |
...
Please refer to Appendix 3.1 - 2.4.3.(IV) Review and Finalize Contract Amendment for the process map.
...
| Role | Responsibilities |
| :--: | :-- |
| Contract <br> Administrator | 1. Raise claim/penalty/dispute or receive claim/penalty/dispute from the Supplier. <br> 2. Review the claim/penalty/dispute along with the Budget Owner. <br> 3. If valid, communicate the details of the claim/penalty/dispute to the "Project Owner". <br> 4. If invalid, communicate to the relevant stakeholder and resolve any query. <br> 5. Receive, complete, and submit the 'Claim/Penalty/Dispute Logging Form'. |
| Project Owner | 6. Initiate the claim/penalty/dispute tasks. <br> 7. Download the 'Claim/Penalty/Dispute Logging Form'. <br> 8. Send the 'Claim/Penalty/Dispute Logging Form' to the Contract Administrator. <br> 9. Upload the completed 'Claim/Penalty/Dispute Logging Form' received from the Contract Administrator. <br> 10. Upload additional documents in the "Contract Folder", if required. |
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Initiate "Review" task(s). <br> 2. "Accept All Changes" recommended by the "Reviewers" or initiate another round of <br> review. |
| Reviewers <br> (as per PDoA) | 3. Review documents in the "Contracts Folder," including the 'Claim/Penalty/Dispute <br> Logging Form'. <br> 4. Provide a modified 'Claim/Penalty/Dispute Logging Form' if required. <br> 5. Deny the claim/penalty/dispute, if deemed invalid from Finance or Legal. |
...
Please refer to Appendix 3.1 - 2.4.3.(VI) Review Contract Claim/Penalty/Dispute for the process map.
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Initiate the "Approval" task. <br> 2. Discuss the claim/penalty/dispute with the Supplier in collaboration with the Contract <br> Administrator, the Legal and the Finance, as required. <br> 3. Modify the "Contract Folder" documents as recommended by the "Approvers". |
| Supplier | 4. Review documents in the "Contract Folder" including the 'Claim/Penalty/Dispute <br> Logging Form'. <br> 5. In case the review leads to modifications, provide modified documents. |
| Approvers <br> (as per PDoA) | 6. Review and approve/deny the 'Claim/Penalty/Dispute Logging Form' along with any <br> other supporting documents. |
...
| Role | Responsibilities |
| :--: | :--: |
| Project Owner | 1. Monitor the "Contract Workspace" for upcoming contract expiry/closure. <br> 2. Initiate the 'Renewal/Extension' amendment, if requested by Contract Administrator. <br> 3. If the contract expiry/closure is approaching, review and complete activities in the 'Contract Closure Checklist'. <br> 4. Upload the completed 'Contract Closure Checklist' and supporting documents in the "Contract Folder". <br> 5. In case of early contract closure, update the 'Expiration Date' in the "Overview" tab. <br> 6. Communicate contract expiry/closure to the relevant stakeholders. <br> 7. Coordinate with the Finance for release of the Performance Bond or retentions, as applicable. |
...
| Procurement Processes |  | Forms and Documents |
| :--: | :--: | :--: |
| 2.4.3. (I) | Initiate and Review Contract | Overview Form |
|  |  | Main Contract Document |
| 2.4.3. (II) | Approve and Publish Contract | Signed Contract Document |
| 2.4.3. (III) | Initiate Contract Amendment | Main Contract Document |
|  |  | Contract Amendment Order |
|  |  | Contract Termination Checklist |
|  |  | Termination Notice |
| 2.4.3. (IV) | Review and Finalize Contract Amendment | Main Contract Document |
|  |  | Contract Amendment Order |
|  |  | Contract Termination Checklist |
|  |  | Termination Notice |
| 2.4.3. (V) | Initiate Contract Claim/Penalty/Dispute | Claim/Penalty/Dispute Logging Form |
| 2.4.3. (VI) | Review Contract Claim/Penalty/Dispute | Claim/Penalty/Dispute Logging Form |
| 2.4.3. (VII) | Settle Contract Claim/Penalty/Dispute | Claim/Penalty/Dispute Logging Form |
| 2.4.3. (VIII) | Close Contract | Contract Closure Checklist |
...
| L3 Process |  |  |  |  |  |  |  |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  | Sourcing <br> Specialist / Lead <br> Contracting <br> Specialist/ Lead <br> Contract <br> Administrator <br> Procurement <br> Manager <br> Supplier <br> Finance <br> Legal <br> SRM Specialist <br> Approvers <br> (as per PDoA) <br> Procurement <br> Scope |  |  |  |  |  |  |  |  |  |
| 2.4.3. (I) Initiate and Review Contract | $R$ | $R, A$ | $R$ | $R$ | $R$ | $R$ | $R$ |  |  | GPO / Entity |
| 2.4.3. (II) Approve and Publish Contract |  | $R, A$ |  |  | I |  |  | I | $R$ | GPO / Entity |
| 2.4.3. (III) Initiate Contract Amendment |  | $R$ | $R, A$ |  |  |  |  |  | $R$ | GPO / Entity |
| 2.4.3. (IV) Review and Finalize Contract Amendment |  | $R, A$ | $R$ |  | $R$ | $R$ | $R$ | I | $R$ | GPO / Entity |
| 2.4.3. (V) Initiate Contract Claim/Penalty/Dispute |  | $R$ | $R, A$ |  | $R$ |  |  |  |  | GPO / Entity |
...
| 2.4.3. (VI) Review Contract <br> Claim/Penalty/Dispute |  | $R, A$ |  |  | $I$ | $R$ | $R$ |  |  | GPO / Entity |
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| 2.4.3. (VII) Settle Contract <br> Claim/Penalty/Dispute |  | $R, A$ |  |  | $R$ | $C$ | $C$ |  | $R$ | GPO / Entity |
| 2.4.3. (VIII) Close Contract | $I$ | $R, A$ | $I$ |  | $I$ | $I$ |  |  |  | GPO / Entity |
...
Segment Suppliers is enabled through "SAP Ariba Knowledge Projects (Supplier Segmentation)". A "Knowledge Projects (Supplier Segmentation)" is created at the GPO level to categorize all Suppliers catering to Common Categories and at each Entity level to categorize all Suppliers catering to EntitySpecific Categories. An SRM Specialist is assigned as the "Project Owner" for "Knowledge Projects (Supplier Segmentation)".
...
| Tab Name | Description |
| :-- | :-- |
| 1. Data Inputs | To provide scores for 'Business Impact and 'Supplier Risk/Complexity' |
| 2. Supplier Segmentation Output | To segment the 'Category - Supplier' combination; (automated tab) |
| 3. Final Supplier Segment | To provide overall segmentation of the Supplier. |
| 4. Scoring Guidelines | Reference tab; to provide 'Business Impact and 'Supplier <br> Risk/Complexity' scores in the 'Data Inputs' tab |
| 5. Category Taxonomy | Reference tab; to fill level 2 category in the 'Data Inputs' tab |
...
Suppliers are segmented at the category level as well as overall Entity/GPO level. The following is an illustration of a Supplier Segmentation Matrix:
...
| $\Theta$ | Required | $\times$ | Not required | May be required |
...
a. Contract Compliance- Contract compliance is monitored and managed through supervision of contract claim/penalty/dispute explained in section 2.4.3.(V).
b. Supplier Performance Evaluation - Please refer to section 2.5.3.(III) for the details of the Supplier Performance Management processes.
c. Supplier Risk Profiling - Please refer to section 2.7.3.(I) for the details of the Supplier Risk Profiling processes.
d. Supplier Development - Please refer to section 2.5.3.(II) for the details of the Supplier Development and Collaboration processes.
e. Supplier Collaboration - Please refer to section 2.5.3.(II) for the details of the Supplier Development and Collaboration processes
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Create a "Knowledge Project (Supplier Segmentation)". <br> 2. Assign Procurement Manager. <br> 3. Prepare and publish "Supplier Segmentation Input Collection Survey". <br> 4. Prepare 'Supplier Segmentation Report'. <br> 5. Initiate "Approval" task. <br> 6. Communicate 'Supplier Segmentation Report' to relevant stakeholders. |
| Survey Participants | 7. Download, complete, and upload "Supplier Segmentation Input Collection Survey". |
| Approvers (as per PDoA) | 8. Review and approve/deny the 'Supplier Segmentation Report'. |
...
| :-- | :-- |
| 1. Contract Lead | Ensures that Supplier collaboration process incorporates key aspects of the <br> contractual relationship between the Entity and Supplier. |
| 2. Business Lead | Provides business/functional inputs in development of Supplier collaboration <br> strategies, processes, and actions. |
| 3. Technical Lead | Provides technical inputs in development of Supplier collaboration strategies, <br> processes, and actions |
| 4. Executive Sponsor | Executive level member responsible for success of the initiative; has authority <br> to make decisions |
| 5. Supplier Representative | SPOC from Supplier organization with respect to development/ collaboration <br> activities |
...
| Tab Name | Description |
| :-- | :-- |
| 1. Development and <br> Collaboration Team | List of team members responsible for managing and executing development and <br> collaboration initiatives |
| 2. Development and <br> Collaboration Plan | Lists the identified development and collaboration opportunities for the Supplier. |
| 3. Progress Tracker | Track the progress made on development and collaboration opportunities <br> identified as high priority in the plan and close all relevant actions. |
| 4. Enablers | Reference tab; Lists potential enablers for Supplier development and <br> collaboration. |
| 5. Category Taxonomy | Reference tab; to fill level 2 category details in the 'Development and <br> Collaboration Plan' tab. |
...
| Role | Responsibilities |
| :--: | :--: |
| SRM Specialist | 1. Shortlist Suppliers for development and collaboration initiatives. <br> 2. Obtain the 'Supplier Development and Collaboration Plan'. <br> 3. Conduct engagement sessions with the Supplier to introduce the initiative. <br> 4. Assign members to the 'Supplier Development and Collaboration Team'. <br> 5. Prepare and publish the 'Supplier Development and Collaboration Plan'. <br> 6. Conduct engagement sessions with the Supplier to finalize the 'Supplier Development and Collaboration Plan' and prioritize opportunities. <br> 7. Monitor and Close the 'Supplier Development and Collaboration Plan'. |
| Supplier | 8. Nominate a representative as SPOC for the development and collaboration initiatives. <br> 9. Participate in engagement initiatives and finalize the 'Supplier Development and Collaboration Plan'. <br> 10. Execute the 'Supplier Development and Collaboration Plan', as required. |
...
Supplier performance is evaluated and monitored regularly against all open contracts. Below is an illustration of how the "SPM Project" is linked to the "Contract Workspace" and how a 'Supplier Performance Scorecard' can be created in the "SPM module"
...
3) Set up "Supplier Performance Input Collection Survey" and 'Supplier Performance Scorecard' The "Project Owner" sets up the 'Supplier Performance Scorecard' by assigning weightage/target grade to each KPI.
...
Contract Administrator for the original "Contract Workspace" and other identified EndUsers participate in the survey.
...
6) Review and publish 'Supplier Performance Scorecard' "SAP Ariba" generates the 'Supplier Performance Scorecard' based on the survey responses received, automatically. The 'Supplier Performance Scorecard' provides Supplier scores against each KPI and indicates the areas of improvement (KPIs where target grade is not met).
...
7) Develop 'Supplier Performance Management (SPM) Plan' If the Supplier performs satisfactorily on all KPIs (met the target grade), the evaluation cycle may be considered closed, and the "Project Owner" repeats the entire process for the next evaluation cycle.
...
1. Supplier Performance Management Plan

To identify root cause for low Supplier scores and develop a mitigation plan for the same.
2. Progress report

To track progress made on the high priority actions identified in the 'SPM Plan'.
...
| Role | Responsibilities |
| :--: | :--: |
| Project Owner | 1. Create "SPM Project". <br> 2. Assign "Team Members". <br> 3. Prepare and publish the 'Supplier Performance Management Survey'. <br> 4. Communicate performance goals to the Supplier. <br> 5. Collate survey responses and publish 'Supplier Performance Scorecard'. <br> 6. Develop 'Supplier Performance Management Plan', if required. <br> 7. Initiate "Approval" task. <br> 8. Share the 'Supplier Performance Scorecard' and 'SPM Plan' with relevant stakeholders. |
| Survey Participants | 9. Complete and submit the "Supplier Performance Survey". |
| Approvers (as per PDoA) | 10. Review and approve/deny 'SPM Plan'. |
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Periodically monitor the progress made against the 'SPM Plan'. <br> 2. Close the 'SPM Plan'. <br> 3. Mark the "SPM Project" - "Complete". |
| Individual executing the <br> 'SPM Plan' | 4. Execute the 'SPM Plan'. |
...
| Procurement Processes |  | Forms and Documents |  |
| :--: | :--: | :--: | :--: |
| 2.5.3. (I) | Segment Suppliers | Overview Form |  |
|  |  | Supplier Segmentation - Category Specific |  |
|  |  | Supplier Segmentation - Consolidated |  |
| 2.5.3. (II) | Set Relationship with Selected Suppliers | Supplier Development and Collaboration Plan |  |
| 2.5.3. (III) | Evaluate Supplier Performance | Overview Form |  |
|  |  | Supplier Performance Management Plan |  |
| 2.5.3. (IV) | Manage Supplier Performance | Supplier Performance Management Plan |  |
...
| L3 Processes |  |  |  |  |  |  |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  | SRM Specialist | Contracting <br> Specialist/ Lead | Procurement <br> Manager | Survey <br> Participants | Supplier <br> Development <br> and <br> Collaboration | Supplier | Approves | Contract <br> Administrator |  |
| 2.5.3. (I) Segment Supplier | $R, A$ |  | I | R |  |  | R | R | GPO / <br> Entity |
| 2.5.3. (II) Set Relationship with Selected Supplier | $R, A$ |  | I |  | $R, A$ | C |  |  | GPO / <br> Entity |
| 2.5.3. (III) Evaluate Supplier Performance |  | $R, A$ | I |  |  | I | R | R | GPO / <br> Entity |
| 2.4.3. (IV) Manage Supplier Performance |  | $R, A$ | I |  |  | R |  |  | GPO / <br> Entity |
...
# 2.6.1 Roles and Responsibilities - Create and Approve PR 

## iii. (B) Roles and Responsibilities

| Role | Responsibilities |
| :--: | :-- |
| End-User | 1. Complete/Update and submit PR for review and approval. <br> 2. Cancel the PR if requirement can be fulfilled by the existing stock/inventory. |
| Approvers <br> (as per PDoA) | 3. Review details and approve/deny PR. <br> 4. Verify if the requirement can be fulfilled by the existing stock/inventory. |
...
| Role | Responsibilities |
| :--: | :-- |
| End-User | 1. Modify PR, if required. |
| Approvers <br> (as per PDoA) | 2. Review details and approve/deny PO. |
| Procurement | 3. Create/update and submit PO for review and approval. <br> 4. Send PO to the Supplier. <br> 5. Modify PO, if partial quantities can be provided by the Supplier. <br> 6. Issue PO to the Supplier |
| Supplier | 7. Confirm receipt of the PO and specify if full/partial PO quantities can be met. |
...
| Role | Responsibilities |
| :--: | :--: |
| Store/ <br> Warehouse <br> (if applicable) | 1. Receive goods and match order against the PO. <br> 2. Accept/reject delivery. <br> 3. Communicate delivery rejection to Procurement and Supplier. <br> 4. Create Goods/Service/Projects Receipt. |
| End-User | 5. Receive goods/services/projects and match order against the PO. <br> 6. Accept/reject delivery. <br> 7. Communicate delivery rejection to Procurement and Supplier. <br> 8. Create Goods/Service/Projects Receipt |
| Approvers | 9. Review and approve/deny the Goods/Service/Projects Receipt |
...
If approvers reject the justification for the emergency purchase, the requested goods/services/projects must be procured through regular channels. If approvers recommend modifications to the justification, the End-User makes the recommended modifications and resubmits PR and justification for the emergency purchase for approval.
...
| Role | Responsibilities |
| :--: | :-- |
| End-User | 1. Complete/update and submit PR and justification for the emergency purchase. |
| Procurement | 2. Coordinate with End-User and store/warehouse to fulfill requirement, if possible. <br> 3. Complete/update and submit PO <br> 4. Identify and Engage Supplier. <br> 5. Obtain requested goods/services/projects and invoice. |
| Approvers <br> (as per PDoA) | 6. Review and approve/deny PR and justification for Emergency purchase <br> 7. Review and approve/deny PO |
...
| Role | Responsibilities |
| :--: | :-- |
| End-User | 1. Check with the store/inventory for availability of required goods. <br> 2. If available, obtain required goods from Store/ Inventory. <br> 3. If unavailable, obtain goods/ services by identifying and engaging Supplier. <br> 4. Receive invoice for goods/ services. |
...
| Role | Responsibilities |
| :--: | :--: |
| End-User | 1. Complete/update and submit post factum PR for review and approval. <br> 2. Create/update post factum Goods/Services/Projects Receipt. <br> 3. Modify PR and Goods/Services/Projects Receipt as recommended by the approvers. |
| Approvers | 4. Review details and approve/deny post factum PR, PO, and Goods/Services/Projects <br> Receipt |
| Procurement | 5. Create/Update and submit post factum PO for review and approval. <br> 6. Modify PO as recommended by the approvers. |
...
Please refer to Appendix 3.1- 2.6.2.(VI) Create and Approve post factum PR-PO-
Goods/Services/Projects Receipt for the process map.
...
| Role | Responsibilities |
| :--: | :-- |
| End-User | 1. Submit Invoice to Finance, in case of Petty Cash and P-Card purchases. <br> 2. Submit PR / Post factum PR to Finance. |

--- Page 145 ---

| Role | Responsibilities |
| :--: | :--: |
|  | 3. Submit Goods/Services/Projects Receipt to Finance, in case of regular and <br> Emergency purchase. |
| Supplier | 4. Submit Invoice (along with the details of the PO), in case of regular and Emergency <br> purchase. |
...
| Procurement Processes |  | Work aids used |
| :--: | :--: | :--: |
| 2.6.2. (I) | Create and Approve PR | Purchase Requisition (PR) |
| 2.6.2. (II) | Create and Approve PO | Purchase Order (PO) |
| 2.6.2. (III) | Receive goods and confirm services | Goods/Services/Projects Receipt |
| 2.6.2. (IV) | Conduct Emergency Procurement | Not applicable |
| 2.6.2. (V) | Conduct Petty Cash/P-Card Procurement | Not applicable |
| 2.6.2. (VI) | Create and Approve post factum PR, PO, and Goods/Services/Projects Receipt | Purchase Requisition (PR), Purchase Order (PO), and Goods/Services/Projects Receipt |
| 2.6.2. (VII) | Receive and Reconcile Invoice | Invoice Receipt |
...
| L3 Process |  |  |  |  |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 2.6.2.(I) Create and Approve PR | $R, A$ |  |  | R | R | C | Entity |
| 2.6.2.(II) Create and Approve PO | I |  | $R, A$ | R |  |  | Entity |
| 2.6.2.(III) Receive Goods/Services/Projects and Confirm | $R, A$ | R | I |  |  | R | Entity |
| 2.6.2.(IV) Conduct Emergency Purchase | $R, A$ |  | R | R |  | C | Entity |
| 2.6.2.(V) Conduct Petty Cash/P-Card Purchase | $R, A$ |  |  |  |  | C | Entity |
| 2.6.2.(VI) Create and Approve post factum PR and Goods/Services/Projects Receipt | $R, A$ |  |  | R |  |  | Entity |
| 2.6.2.(VI) Create and Approve post factum PO | I |  | $R, A$ | R |  |  | Entity |
| 2.6.2.(VII) Receive and Reconcile Invoice | R | R | I |  | $R, A$ | C | Entity |
...
The Profile Supplier Risk process is conducted periodically, preferably once a year, to identify highrisk Suppliers and optimize the risk mitigation efforts. As per the Supplier Segment Strategy, the risk profiling is conducted for following Suppliers:
...
| Tab Name | Description |
| :-- | :-- |
| Supplier Risk Profile | To obtain details regarding Supplier risk profiles from survey participants and identify <br> high-risk Suppliers. |
| Risk Profiling Criteria | Reference tab; provides detailed criteria to score the Supplier on Financial, <br> Operational, Environmental, and Legislative Impacts in 'Supplier Risk Profiles' tab. |
| Category Taxonomy | Reference tab; to add level 2 category details in 'Supplier Risk Profiles' tab. |
...
| Role | Responsibilities |
| :--: | :--: |
| Project Owner | 1. Create "Knowledge Project (Supply Risk) - Supplier Risk Profiling". <br> 2. Prepare and publish the "Supplier Risk Profile Input Collection Survey". <br> 3. Consolidate survey responses in the 'Supplier Risk Profiling - Consolidated' document and identify high-risk Suppliers. <br> 4. Upload completed 'Supplier Risk Profiling - Consolidated' in "Knowledge Project (Supply Risk) - Profile Supplier Risk". |
| Survey Participants | 5. Download, complete and upload 'Supplier Risk Profiling' document Table 2.7.2 Roles and Responsibilities - Profile Supplier Risk |
...
| Tab Name | Description |
| :-- | :-- |
| 1. Risk Identification | To capture the details regarding the risks - products \& services impacted, type of <br> risk, etc. |
| 2. Risk Assessment | To identify and evaluate the impact of the risk (in terms of likelihood and severity) |
| 3. Risk Mitigation | To identify potential mitigation approaches and details for identified risks |
| 4. Risk Assessment <br> Criteria | Reference tab: To provide the criteria for quantifying the likelihood and severity of <br> different types of risks |
| 5. Risk Mitigation <br> Approaches | Reference Tab: To provide different types of approaches which can be adopted to <br> mitigate identified risks |
...
To maintain a live record of all procurement-related risks identified by various stakeholders. Risks identified as high-priority risks in this tab are reviewed and approved by the "Approvers" before executing the respective 'Mitigation Plan.'
...
iii. (5) Roles and Responsibility

| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Create "Knowledge Project (Supply Risk) - Mitigate Risk". <br> 2. Assign Procurement Manager. <br> 3. Prepare and publish "Risk Register Input Collection Survey" <br> 4. Consolidate survey responses and complete 'Risk Register and Mitigation Tracker' document. |
| Survey <br> Participants | 5. Download, complete and upload the filled 'Risk Identification, Assessment, and <br> Mitigation' document. |
...
Please refer to Appendix 3.1 - 2.7.3.(II) Identify and Assess Risk for the process map.
...
The 'Risk Register and Mitigation Tracker' document is reviewed and approved by "Approvers" designated as per the PDoA. The "Approvers" may consider (but not limited to) the following points while reviewing the document:
...
Risk Mitigation
Progress Tracker
To monitor the progress made toward closure of the identified high-priority risks.
...
| Role | Responsibilities |
| :--: | :-- |
| Project Owner | 1. Initiate "Approval" task. <br> 2. Complete the 'Risk Mitigation Progress Report' document with details of the approved high priority risks. <br> 3. Initiate periodic reviews of the 'Risk Mitigation Progress Report' document to monitor the progress made towards closure of identified high-priority risks. <br> 4. Update the status of risk in the 'Risk Register and Mitigation Tracker' document with each review and upload the document. <br> 5. Close the "Knowledge Project (Supply Risk) - Mitigate Risk" |
| Relevant <br> Stakeholders | 6. Update and submit the 'Risk Mitigation Progress report' document, as required. |
| Approvers <br> (as per PDoA) | 7. Review and approve/deny the 'Risk Register and Mitigation Tracker' document. |
...
| Section Name | Description |
| :--: | :--: |
| 1. Regulation Overview | Provides overview details of the regulation change (such as regulation no., description, categories impacted, products impacted, etc.) |
| 2. Impact on Procurement | Details actions to be taken for compliance with associated timelines, dependencies, entities affected, and budget requirement |
| 3. Implementation Activities | Detailed activities to be conducted along with RACI Matrix |
| 4. Communication Plan | Details of all communications required to monitor and execute the regulation change, including persons targeted, dates and key messages to be communicated |
| 5. Potential Risks and Issues | Details all potential risks in the implementation of the regulation change |
| 6. Implementation Plan timelines | Details timelines for all activities listed in the 'Implementation Activities' |
| 7. Regulation Change Tracking | Monitors progress made by each affected entity and progress made against each 'Implementation Activity.' |
...
The completed 'Regulation Change' document is uploaded in the "Documents" tab for approval by "Approvers" designated by the PDoA.
...
| Role | Responsibilities |
| :--: | :--: |
| Project Owner | 1. Assess upcoming regulation change to identify impacts on the Procurement. <br> 2. Create the "Knowledge Project (Supply Risk) - Regulation Change". <br> 3. Download, complete, and upload the 'Regulation Change' document. <br> 4. Initiate "Approval" task. <br> 5. Share the approved 'Regulation Change' document with relevant stakeholders. <br> 6. Conduct periodic reviews to monitor the progress made against the activities <br> detailed in the 'Regulation Change' document. <br> 7. Update and upload the 'Regulation Change' document with each review. <br> 8. Close the "Knowledge Project (Supply Risk) - Regulation Change" |
| Relevant <br> Stakeholders | 9. Update the 'Regulation Change Tracking' section of the 'Regulation Change' document <br> with updated status of actions and upload the document |
| Approvers <br> (as per PDoA) | 10. Review and approve/deny the 'Regulation Change' document. |
...
| Procurement Processes |  | Forms and Documents |  |
| :-- | :-- | :-- | :-- |
| 2.7.3. (I) | Profile Supplier Risk | Overview Form |  |
|  |  | Supplier Risk Profiling |  |
|  |  | Supplier Risk Profiling - Consolidated |  |
| 2.7.3. (II) | Identify and Assess Risk | Overview Form |  |
|  |  | Risk Identification, Assessment, and Mitigation |  |
|  |  | Risk Register and Mitigation Tracker |  |
| 2.7.3. (III) | Mitigate and Close Risk | Risk Register and Mitigation Tracker |  |
|  |  | Risk Mitigation Progress Report |  |
| 2.7.3. (IV) | Implement Regulation Change | Overview Form |  |
|  |  | Regulation Change |  |
...
| L3 Process | SRM Specialist | Regulation and Risk Lead - GPO | Contract Administrator (End-User Dept.) | Survey <br> Participants | Supplier | Finance | Legal | Approvers (as per PDoA) | Procurement Scope |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 2.7.3. (I) Profile Supplier Risk | R, A |  | R | R | I |  |  |  | GPO / Entity |
| 2.7.3. (II) Identify and Assess Risk | R, A |  | R | R |  |  |  |  | GPO / Entity |
| 2.7.3. (III) Mitigate and Close Risks | R, A |  |  |  | R |  |  | R | GPO / Entity |
| 2.4.3. (IV) Implement Regulation Change |  | R, A |  |  |  | C | C | R | GPO |
...
Below is an illustration of how the "Registration Request" and registration requirements change based on the Supplier classification:
...
a. AD-DED Suppliers raise a "Supplier Self-Registration Request" by opening the "SAP Ariba Supplier Self-Registration Request link" and completing and submitting the "SelfRegistration Request form".
...
| Role | Responsibilities |
| :--: | :--: |
| Supplier | 1. Raise "Self Registration Request" , in case of AD-DED Suppliers. <br> 2. Request an Entity to raise "Entity Raised Supplier Request", in case of Non - ADDED Suppliers. <br> 3. Provide all information and documentation requested by the Entity to raise the "Entity Raised Supplier Request". <br> 4. Raise queries, if any. |
| Entity user | 5. Complete and submit the "Entity-Raised Supplier Request" for Non - AD-DED Suppliers. |
| Supplier Data <br> Management Lead | 6. Assign "Registration Request" to one of the Supplier Data Management Specialists. |
| Supplier Data <br> Management Specialist | 7. Review the "Registration Request" for accuracy and duplication. <br> 8. Assign "Supplier Manager". |
...
While filling the "General Registration Questionnaire", Foreign Suppliers must download, review, and agree to the 'Attestation Requirements' elaborated in point (c) below.
...
| Role | Responsibilities |
| :--: | :--: |
| Supplier | 1. Create the "SAP Ariba Network Light Account". <br> 2. Complete and submit the "General Registration Questionnaire" and the "Payment and Bank Questionnaire". <br> 3. Download and review the 'Attestation Requirements' (only applicable for Foreign Suppliers). <br> 4. Provide requested documents along with necessary attestations (only applicable for Foreign Suppliers). |
| Supplier Manager | 5. Review and approve the "General Registration Questionnaire". <br> 6. Seek clarifications from the Supplier (if any) <br> 7. Complete the "Internal Questionnaire" |
| Bank Information Specialist | 8. Review and approve the "Payment and Bank Questionnaire". <br> 9. Seek clarifications from the Supplier (if any) |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier | 1. Raise request to open the "Registration Questionnaires" <br> 2. Update information in the "General Registration Questionnaire" and "Payment and <br> Bank Questionnaire" |
| Entity User | 3. Request "Supplier Manager" to add a Non - AD-DED Supplier to the Entity's scope. |
| Supplier Manager | 4. Open the "Registration Questionnaires" <br> 5. Review and approve the "General Registration Questionnaire", (if updated) <br> 6. Update the "Internal Questionnaire" (if reqd.) |
| Bank Information <br> Specialist | 7. Review and approve the "Payment and Bank Questionnaire" (if updated) |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier | 1. Receive the "Qualification Questionnaire". <br> 2. Complete and submit "Qualification Questionnaire". <br> 3. Re-qualify Supplier, as required. |

--- Page 177 ---

| Role | Responsibilities |
| :--: | :-- |
| Entity User | 4. Request "Supplier Manager" to disqualify a Supplier. |
| Supplier Manager | 5. Send "Qualification Questionnaire" to the Supplier. <br> 6. Review and approve the "Qualification Questionnaire". <br> 7. Qualify Non - AD-DED Supplier for the requesting Entity. |
| Supplier Data <br> Management Lead | 8. Review and approve the "Qualification Questionnaire". |
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier Manager | Decide if the Supplier should be marked as "Preferred" for a category or not. |
|  | Mark the Supplier "Preferred", if required. |
...
| Supplier | 3. Update the commercial/industrial License in "General Registration <br> Questionnaire". |
...
The process to provide renewed license details in the "General Registration Questionnaire" is part of the Update Supplier Registration process explained in section 2.8.3.(III).
...
| Role | Responsibilities |
| :--: | :-- |
| Supplier | 1. Raise Request to open the "General Registration Questionnaire" if required. <br> 2. Submit renewed commercial/industrial license. |
| Supplier Manager | 3. Review and approve request to open the "General Registration Questionnaire". <br> 4. Review the renewed commercial/industrial license. <br> 5. Mark the supplier "Reactivated" and provide justification. |
...
| Procurement Processes |  | Forms and Documents |
| :--: | :--: | :--: |
| 2.8.3. (I) | Initiate Supplier Registration | Self-Registration Request Form |
|  |  | Entity Raised Request Form |
| 2.8.3. (II) | Register Supplier | General Registration Questionnaire |
|  |  | Internal Questionnaire |
|  |  | Payment and Bank Questionnaire |
| 2.8.3. (III) | Update Supplier Registration | General Registration Questionnaire |
|  |  | Internal Questionnaire |
|  |  | Payment and Bank Questionnaire |
| 2.8.3. (IV) | Qualify/Disqualify Supplier | Qualification Questionnaire |
...
| L3 Process | Supplier <br> Management <br> Data Lead | Supplier <br> Management <br> Data Specialist | Entity User | Supplier | Supplier Manager | Bank Information <br> Specialist | Procurement <br> Scope |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 2.8.3.(I) Initiate and approve Supplier Request | R | $R, A$ | R | R |  |  | GPO / Entity |
| 2.8.3.(II) Register Supplier |  |  |  | R | $R, A$ | R | GPO / Entity |
| 2.8.3.(III) Update Supplier Registration |  |  |  | R | $R, A$ | R | GPO / Entity |
| 2.8.3.(IV) Qualify/ Disqualify Supplier | R |  | R | R | $R, A$ |  | GPO / Entity |
| 2.8.3.(V) Identify Preferred Suppliers |  |  | I | I | $R, A$ |  | GPO / Entity |
| 2.8.3.(VI) Deactivate Supplier | I |  | I | R | $R, A$ |  | GPO / Entity |
| 2.8.3.(VII) Reactivate Supplier | I |  | I | R | $R, A$ |  | GPO / Entity |
...
| L3 Process | Entity <br> Requestor | Item Master <br> Data Team | Approves <br> (to PcP <br> PDOA) | Procurement <br> Scope |
| :--: | :--: | :--: | :--: | :--: | :--: |
...
| Role | Responsibilities |
| :--: | :--: |
| Entity Requestor | 1. Download 'SAP Ariba Enablement Form' from "Abu Dhabi Procurements Portal" <br> 2. Complete, sign and submit 'SAP Ariba Enablement Form' to Head of Procurement. <br> 3. Submit approved 'SAP Ariba Enablement Form' in "Abu Dhabi Procurements Portal ". <br> 4. Select "GPO Approver". <br> 5. Modify 'SAP Ariba Responsibility Form' as per the recommendation of Head of Procurement/ "GPO Approver" <br> 6. Follow email instructions and set password (in case of new user) |
| Head of the Procurement | 7. Review and approve/deny the 'SAP Ariba Enablement Form'. |
| User Enablement Team | 8. Complete required actions in "SAP Ariba" to complete the request. <br> 9. Close request in "Abu Dhabi Procurements Portal". |
| GPO Approver | 10. Review and approve/deny the 'SAP Ariba Enablement Form'. |
| New User | 11. Follow email instructions and set password. |
...
| Role | Responsibilities |
| :--: | :--: |
| Requestor | 1. Submit password reset request to GPO Helpdesk via email. <br> 2. Submit "SAP Ariba" access delegation request to GPO Helpdesk, via email. <br> 3. Reset "SAP Ariba" password as per the instructions received in the email. |
| GPO <br> Helpdesk | 4. Receive requests from "Requestor" and communicate to "User Enablement Team". <br> 5. Receive confirmation from "User Enablement Team" and communicate to "Requestor". |
| User <br> Enablement <br> Team | 6. Complete request in "SAP Ariba". <br> 7. Communicate request completion to GPO Helpdesk. <br> 8. Inform delegatee of the delegation done (in case of delegation request). |
...
Please refer to Appendix 3.1 - 2.10.3.(II) Delegate User/Reset "SAP Ariba" Password for the process map.
2.10.4 Work Aids - Documents and "SAP Ariba" templates

| Procurement Processes |  | Forms and Documents |
| :-- | :-- | :-- |
| 2.10.3.(I) | Enable/Modify/Deactivate User | SAP Ariba Enablement Form |
| 2.10.3.(II) | Delegate User / Reset "SAP Ariba" Password | Not Applicable |
...
Figure 2.6.12 Process Flow and Key Tasks - Create and Approve post factum PR - PO - Goods/Services/Projects Receipt. ..... 141
...
| "Abu Dhabi <br> Procurements Portal" | Digital Marketplace presenting information, enabling access to procurement <br> services and consolidating information across all Entities. |
| :-- | :-- |
| "Approver" | A system role assigned for reviewing and approving/denying documents/tasks as <br> per the Procurement Delegation of Authority (PDoA). |
| "Bank Information <br> Specialist" | A system role assigned for validating the information provided in the "Payment and <br> Bank Questionnaire". |
...
| "Bid Console" | A functionality within "SAP Ariba" (for eAuctions) to receive and monitor <br> commercial bids. |
...
| 'Category' | Groupings of similar goods/services/projects. |
| Category Management | A strategic approach to procurement by segmenting spend into categories for <br> driving savings, consolidation and efficiency. |
| "Commercial Envelope" | Envelope enabled in "SAP Ariba" Sourcing Event to record and evaluate Suppliers' <br> commercial responses. |
| Common Category | Category procured by five or more Entities. |
| "Contract Folder" | A folder within the "Contract Workspace" where all relevant documents related to <br> the contract are stored. |
| "Contract Manager" | "SAP Ariba" Project Group including Contract Specialist/Contract Lead assigned for <br> creating and managing the "Contract Workspace". |
| "Contract Workspace" | "SAP Ariba" workspace (within "SAP Ariba" CLM module) where activities related to <br> creating, publishing, managing and closing contracts are executed. |
| End-User | The requesters or requesting parties of goods, services and projects. |
| Entity | Local departments and every juridical person reporting to the Government and <br> having full legal capacity to act and manage a public facility or aiming to provide a <br> public service. |
| "Contract Workspace" | Category procured by less than five Entities |
| Finance | The function within the government entity dedicated to financial affairs. |

--- Page 245 ---

| "Full Sourcing Project" | Type of the "Sourcing Project" preferred for strategic sourcing initiatives requiring creation of 'Sourcing Strategy'. |
| :--: | :--: |
...
| Non-Catalogue | Goods/services not part of the Catalogue. |
| Payment Terms | Terms specifying the number of days available and other conditions for transferring the payment of accepted goods/services/projects to the Supplier. |
...
| "Project Groups" | The groups of participants involved in the design and execution of various activities within "SAP Ariba" projects (e.g. "Sourcing Project", "Contract Workspace"). |
| "Project Owner" | A system role assigned for execution of "SAP Ariba" projects (e.g. "Sourcing Project", "Contract Workspace"). |
...
| "Quick Sourcing Project" | Type of the "Sourcing Project" preferred for non-strategic sourcing initiative without 'Sourcing Strategy'. |
...
| "Reviewer" | A system role assigned for reviewing documents/tasks as per the Procurement Delegation of Authority (PDoA). |
| "SAP Ariba Dashboard" | "SAP Ariba" home screen available after login, providing navigation elements, common actions, and relevant content based on user role. |
| "SAP Ariba Discovery" | A free business-to-business (B2B) marketplace designed to connect buyers and suppliers. |
...
| "Sourcing Library" | Repository of standard (best practice) documents, templates and questions that may be used in a Sourcing Event. |
| "Sourcing Project" | "SAP Ariba" workspace for conducting sourcing activities and awarding Suppliers. |

--- Page 247 ---

| "Sourcing Request" | A request to find the supply source for the required goods/services/projects. |
| :-- | :-- |
| "SPM Project" | "SAP Ariba" workspace that enables evaluation, monitoring, and management of <br> the Supplier performance against contracts. |
| "Supervisor" | Immediate manager of the "Project Owner". |
| Supplier | An individual or an organization engaged to supply the goods, services or projects. |
| "Supplier Manager" | A system role assigned for registering and qualifying Suppliers. |
| "System Groups" | The groups of participants pre-determined in "SAP Ariba" for reviews and approvals <br> as per the Procurement Delegation of Authority (PDoA). |
| "Team Grader" | A system role assigned for reviewing 'Sourcing Strategy' and performing evaluation <br> of Sourcing Event. |
| "Technical and <br> Commercial Envelope" | A single envelop enabled in "SAP Ariba" for obtaining technical and commercial bids <br> together. |
| "Technical Envelope" | Envelope enabled in "SAP Ariba" for obtaining technical bids separately. |
| Tendering Committee | A committee established to evaluate the results of relevant tenders and encourage <br> cross-functional collaboration. |
| "User Enablement Team" | A team in the GPO responsible for implementing requests in "SAP Ariba" related to <br> the user enablement, modification, delegation and deletion. |